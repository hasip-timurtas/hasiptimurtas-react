    ...
    render() {
      ...
      return (
		...
		<div className="resume-profile">
			...
			{new Date().getFullYear() - 2009} Years<br />
			<br />

			<strong>Address</strong> <br /> 
			Yavuz Sultan Selim district<br />
			Mihri Kelam ST.<br />
			Istanbul<br />
			Turkey<br />
		...
		<div className="resume-social">
			...
			/hasiptimurtas
			<a href="https://www.linkedin.com/in/hasiptimurtas" className="btn btn-social-icon btn-xs btn-linkedin" target="_blank"><i className="fa fa-linkedin"></i></a>
			<br />

			/hasip-timurtas
			<a href="https://github.com/hasip-timurtas" className="btn btn-social-icon btn-xs btn-github" target="_blank" ><i className="fa fa-github"></i></a>
			<br />

			+hasipTimurtas
			<a href="https://plus.google.com/+hasipTimurtas" className="btn btn-social-icon btn-xs btn-google" target="_blank"><i className="fa fa-google"></i></a>
			<br />
			
			@hasip_timurtas
			<a href="https://twitter.com/hasip_timurtas" className="btn btn-social-icon btn-xs btn-twitter" target="_blank"><i className="fa fa-twitter"></i></a>
			<br />

			/hasip.timurtas 
			<a href="https://www.facebook.com/hasip.timurtas" className="btn btn-social-icon btn-xs btn-facebook" target="_blank"><i className="fa fa-facebook"></i></a>
			<br />					
